...
(function() {
  ...
  var Ja = Array.prototype.indexOf
    ...
    La = Array.prototype.filter
      ...
      : function(a, b, c) {
          for (
            var d = a.length, e = [], f = 0, g = q(a) ? a.split("") : a, k = 0;
            k < d;
            k++
          )
            if (k in g) {
    ...
    Sa = function(a, b) {
      ...
      var c;
      if ((c = 0 <= b))
        D(null != a.length), Array.prototype.splice.call(a, b, 1);
      return c;
    },
    Ta = function(a) {
  ...
  var nb = E("Opera"),
    ...
    G =
      E("Gecko") &&
      !(-1 != Va.toLowerCase().indexOf("webkit") && !E("Edge")) &&
      !(E("Trident") || E("MSIE")) &&
      !E("Edge"),
  ...
  Gb =
    Hb && F
      ? yb() || ("CSS1Compat" == Hb.compatMode ? parseInt(Db, 10) : 5)
      : void 0;
  var Eb = Gb;
  var Ib = E("Firefox"),
    Jb = hb() || E("iPod"),
  ...
  var Ob = function() {},
    ...
    Tb = function(a, b, c) {
      b < a.i ? (a.a[b + a.c] = c) : (Rb(a), (a.h[b] = c));
    },
    Ub = function(a) {
      if (a.b)
        for (var b in a.b) {
          var c = a.b[b];
          if (w(c)) for (var d = 0; d < c.length; d++) c[d] && c[d].wa();
          else c && c.wa();
        }
    };
          ...
          : (2048 > k
              ...
              : (55296 == (k & 64512) &&
                ...
                56320 == (a.charCodeAt(g + 1) & 64512)
                  ? ((k =
                      65536 + ((k & 1023) << 10) + (a.charCodeAt(++g) & 1023)),
                    (e[f++] = (k >> 18) | 240),
                    (e[f++] = ((k >> 12) & 63) | 128))
                  : (e[f++] = (k >> 12) | 224),
                (e[f++] = ((k >> 6) & 63) | 128)),
  ...
  var ec = function(a, b) {
    a.C
      ? p(void 0)
        ? b.call(void 0)
        : b()
      : (a.G || (a.G = []), a.G.push(p(void 0) ? z(b, void 0) : b));
  };
  ...
  var ic = function(a, b) {
    ...
    if (a) {
      ...
      (b = a.relatedTarget)
        ? G && (kb(b, "nodeName") || (b = null))
        : "mouseover" == c
        ? (b = a.fromElement)
        : "mouseout" == c && (b = a.toElement);
      this.relatedTarget = b;
      null === d
        ? ((this.offsetX = H || void 0 !== a.offsetX ? a.offsetX : a.layerX),
    ...
    kc = function(a) {
      return (
        ($b
          ...
          : "click" == a.type
          ? !0
          : !!(a.ea.button & jc[0])) && !(H && rb && a.ctrlKey)
      );
    };
  ...
  qc.prototype.add = function(a, b, c, d, e) {
    ...
    -1 < g
      ? ((b = a[g]), c || (b.Ka = !1))
      : ((b = new oc(b, this.src, f, !!d, e)), (b.Ka = c), a.push(b));
    return b;
  };
  ...
  var rc = function(a, b, c, d) {
    for (var e = 0; e < a.length; ++e) {
      var f = a[e];
      if (!f.removed && f.listener == b && f.capture == !!c && f.Na == d)
        return e;
    }
    return -1;
  };
  var tc = "closure_lm_" + ((1e6 * Math.random()) | 0),
    ...
    xc = function(a, b, c, d, e) {
      ...
      c = yc(c);
      return mc(a)
        ? a.listen(b, c, y(d) ? !!d.capture : !!d, e)
        : zc(a, b, c, !1, d, e);
    },
    ...
    wc = function(a, b, c, d, e) {
      ...
      c = yc(c);
      return mc(a)
        ? a.ib(b, c, y(d) ? !!d.capture : !!d, e)
        : zc(a, b, c, !0, d, e);
    },
    Ec = function(a, b, c, d, e) {
      if (w(b)) for (var f = 0; f < b.length; f++) Ec(a, b[f], c, d, e);
      else
        (d = y(d) ? !!d.capture : !!d),
          (c = yc(c)),
          mc(a)
            ? a.S(b, c, d, e)
            : a && (a = Ac(a)) && (b = a.Ca(b, c, d, e)) && Fc(b);
    },
    Fc = function(a) {
      ...
      b.removeEventListener
        ...
        : b.detachEvent && b.detachEvent(Cc(c), d);
      vc--;
      (c = Ac(b))
        ? (sc(c, a), 0 == c.b && ((c.src = null), (b[tc] = null)))
        : pc(a);
      return !0;
    },
    Gc = function(a) {
    ...
    Dc = function(a, b) {
      ...
      if (!ac) {
        ...
        if (!(0 > d.keyCode || void 0 != d.returnValue)) {
          ...
          for (e = 0; !b.pa && e < d.length; e++)
            (b.currentTarget = d[e]), (f = Ic(d[e], a, !1, b)), (c = c && f);
        }
        return c;
      }
  ...
  var Kc = function(a) {
    ...
    Mc = function(a, b) {
      a.classList
        ? a.classList.add(b)
        : Lc(a, b) || (a.className += 0 < a.className.length ? " " + b : b);
    },
    Nc = function(a, b) {
      if (a.classList)
        Ka(b, function(b) {
    ...
    pd = function(a) {
      ...
      if (a instanceof Vc) a = Wc(a);
        ...
        if (nd.test(b)) {
          ...
          b && c
            ? (a = od(a))
            : (Ba("String value requires balanced quotes, got: " + a),
              (a = "zClosurez"));
        } else
          Ba(
  ...
  var Ad = {
    ...
    Cd = function(a, b) {
      var c =
        ((c = a && a.ownerDocument) && (c.defaultView || c.parentWindow)) || n;
      if (
        ...
        c =
          a &&
          (a instanceof c.HTMLScriptElement ||
  ...
  var Hd = function(a) {
    ...
    Od = function(a) {
      var b = Md(a);
      a = Nd(a);
      return F && I("10") && a.pageYOffset != b.scrollTop
        ? new L(b.scrollLeft, b.scrollTop)
        : new L(a.pageXOffset || b.scrollLeft, a.pageYOffset || b.scrollTop);
    },
    Md = function(a) {
    ...
    $d = function(a, b, c) {
      if (!(a.nodeName in Wd))
        ...
        else for (a = a.firstChild; a; ) $d(a, b, c), (a = a.nextSibling);
    },
    Qd = function(a) {
  ...
  de.prototype.remove = function(a) {
    return ge(this.b, a)
      ? (delete this.b[a],
        this.c--,
        this.h++,
        this.a.length > 2 * this.c && ee(this),
        !0)
      : !1;
  };
  var ee = function(a) {
    ...
    if (a.c != a.a.length) {
      ...
      for (c = b = 0; b < a.a.length; )
        (d = a.a[b]), ge(e, d) || ((a.a[c++] = d), (e[d] = 1)), b++;
      a.a.length = c;
    }
  };
  ...
  le.prototype.remove = function(a) {
    me(this);
    a = ne(this, a);
    return ge(this.a.b, a)
      ? ((this.c = null),
        (this.b = Ca(this.b) - this.a.get(a).length),
        this.a.remove(a))
      : !1;
  };
  ...
  var De = function(a, b, c) {
    ...
    Ce = function(a, b) {
      ...
      if (!c) {
        ...
        void 0 === a.style[d] &&
          ((d =
            (H ? "Webkit" : G ? "Moz" : F ? "ms" : nb ? "O" : null) + ya(d)),
    ...
    Me = function(a) {
      for (
        var b = new Ae(0, Infinity, Infinity, 0),
          c = Hd(a),
          d = c.a.body,
    ...
    Qe = function(a) {
      var b = a.offsetWidth,
        c = a.offsetHeight,
        d = H && !b && !c;
      return (p(b) && !d) || !a.getBoundingClientRect
        ? new Ed(b, c)
        : ((a = Je(a)), new Ed(a.right - a.left, a.bottom - a.top));
    },
    Se = function(a) {
      var b = Le(a);
      a = Re(a);
  ...
  h.dispatchEvent = function(a) {
    ...
    a.pa ||
      ...
      a.pa || (e = ef(g, d, !1, a) && e));
    if (c)
      for (f = 0; !a.pa && f < c.length; f++)
        (g = a.currentTarget = c[f]), (e = ef(g, d, !1, a) && e);
    return e;
  };
  h.s = function() {
    M.m.s.call(this);
  ...
  h.Wb = function(a) {
    ...
    -1 == this.M &&
      (a.ctrlKey && 17 != a.keyCode
        ...
        ? (this.M = 18)
        : a.metaKey && 91 != a.keyCode && (this.M = 91));
    jf && !bf(a.keyCode, this.M, a.shiftKey, a.ctrlKey, a.altKey, a.metaKey)
      ? this.handleEvent(a)
      : ((this.ma = af(a.keyCode)), kf && (this.Sa = a.altKey));
  };
  h.Yb = function(a) {
    this.ma = this.M = -1;
    this.Sa = a.altKey;
  ...
  h.handleEvent = function(a) {
    ...
    if (F && "keypress" == a.type) {
      ...
      (H || ob) && "keypress" == a.type
        ? ((d = this.ma),
          (e = 0 <= b.charCode && 63232 > b.charCode && $e(d) ? b.charCode : 0))
        : nb && !H
        ? ((d = this.ma), (e = $e(d) ? b.keyCode : 0))
        : ((d = b.keyCode || this.ma),
          (e = b.charCode || 0),
          kf && (c = this.Sa),
          rb && 63 == e && 224 == d && (d = 191));
    ...
    d
      ? 63232 <= d && d in gf
        ? (f = gf[d])
        : 25 == d && a.shiftKey && (f = 9)
      : b.keyIdentifier && b.keyIdentifier in hf && (f = hf[b.keyIdentifier]);
    a = f == this.M;
    this.M = f;
    b = new lf(f, e, a, b);
    b.altKey = c;
  ...
  var sf = function(a, b, c, d, e, f) {
    if (w(c)) for (var g = 0; g < c.length; g++) sf(a, b, c[g], d, e, f);
    else {
  ...
  qf.prototype.S = function(a, b, c, d, e) {
    if (w(b)) for (var f = 0; f < b.length; f++) this.S(a, b[f], c, d, e);
    else
  ...
  N.prototype.removeChild = function(a, b) {
    if (a) {
      ...
      this.u && c
        ? ((a = this.u), (a = (null !== a && c in a ? a[c] : void 0) || null))
        : (a = null);
      if (c && a) {
        var d = this.u;
        c in d && delete d[c];
  ...
  Cf.prototype.ia = function(a, b) {
    b.id && wf(a, b.id);
    b && b.firstChild
      ? If(a, b.firstChild.nextSibling ? Ua(b.childNodes) : b.firstChild)
      : (a.Ea = null);
    var c = 0,
      d = this.F(),
      e = this.F(),
  ...
  var Kf = function(a, b) {
    if ((a = a.Za())) {
      ...
      a != c &&
        (a
          ? (D(bb(of, a), "No such ARIA role " + a), b.setAttribute("role", a))
  ...
  h.ba = function() {
    ...
    this.c.Gb(this);
    this.H & -2 &&
      (this.cb && Qf(this, !0), this.H & 32 && (a = this.l())) &&
      ((b = this.j || (this.j = new ff())),
      b.attach(a),
      yf(this)
        .listen(b, "key", this.Xb)
        .listen(a, "focus", this.Vb)
  ...
  var Qf = function(a, b) {
    ...
    b
      ? (c
          .listen(d, "mouseover", a.Eb)
          .listen(d, "mousedown", a.Fa)
          .listen(d, "mouseup", a.Ga)
          .listen(d, "mouseout", a.Db),
        a.Ma != t && c.listen(d, "contextmenu", a.Ma),
        F &&
          (I(9) || c.listen(d, "dblclick", a.Cb),
          a.D || ((a.D = new Tf(a)), ec(a, A(fc, a.D)))))
      : (c
          .S(d, "mouseover", a.Eb)
          .S(d, "mousedown", a.Fa)
          .S(d, "mouseup", a.Ga)
          .S(d, "mouseout", a.Db),
        a.Ma != t && c.S(d, "contextmenu", a.Ma),
        F && (I(9) || c.S(d, "dblclick", a.Cb), fc(a.D), (a.D = null)));
  };
  ...
  O.prototype.setEnabled = function(a) {
    ...
    (b && "function" == typeof b.b && !b.b()) ||
      !Vf(this, 1, !a) ||
      (a || (Wf(this, !1), Xf(this, !1)),
      this.oa && this.c.Ra(this, a),
      Yf(this, 1, !a, !0));
  };
  var Xf = function(a, b) {
      Vf(a, 2, b) && Yf(a, 2, b);
  ...
  var Yf = function(a, b, c, d) {
      d || 1 != b
        ? a.H & b &&
          c != !!(a.w & b) &&
          (a.c.ab(a, b, c), (a.w = c ? a.w | b : a.w & ~b))
        : a.setEnabled(!c);
    },
    Zf = function(a) {
    ...
    Vf = function(a, b, c) {
      return (
        !!(a.H & b) &&
        !!(a.w & b) != c &&
        (!(0 & b) || a.dispatchEvent(vf(b, c))) &&
        !a.C
      );
    };
  h = O.prototype;
  h.Eb = function(a) {
    (!a.relatedTarget || !Ud(this.l(), a.relatedTarget)) &&
  ...
  h.Db = function(a) {
    (a.relatedTarget && Ud(this.l(), a.relatedTarget)) ||
      ...
      (P(this, 4) && Wf(this, !1), P(this, 2) && Xf(this, !1));
  };
  h.Ma = t;
  h.Fa = function(a) {
    this.b() &&
      ...
      kc(a) &&
        (P(this, 4) && Wf(this, !0),
        this.c && this.c.zb(this) && this.l().focus()));
    kc(a) && a.preventDefault();
  };
  h.Ga = function(a) {
    this.b() &&
      (P(this, 2) && Xf(this, !0),
      this.w & 4 && this.Ha(a) && P(this, 4) && Wf(this, !1));
  };
  h.Cb = function(a) {
    this.b() && this.Ha(a);
  };
  ...
  h.Xb = function(a) {
    return this.oa && this.b() && this.bb(a)
  ...
  var Tf = function(a) {
    ...
    a = xf(this.b);
    this.c
      .listen(a, "mousedown", this.i)
      .listen(a, "mouseup", this.j)
  ...
  var eg = function(a) {
    ...
    gg = function(a) {
      return null != a && a.aa === pe
        ? (D(a.constructor === ue), a)
        : a instanceof rd
        ? fg(sd(a), a.ua())
        : fg(ua(String(String(a))), eg(a));
    },
    fg = (function(a) {
      function b(a) {
        this.content = a;
  ...
  var ng = function(a) {
    ...
    f +=
      (1 == e.width ? " jfk-button-narrow" : "") +
      (e.checked ? " jfk-button-checked" : "") +
      (e.Sb ? " " + e.Sb : "") +
      (e.disabled ? " jfk-button-disabled" : "");
    d =
      d +
      R(new te(f, void 0)) +
      '"' +
      (a.disabled
        ? ' aria-disabled="true"'
        : ' tabindex="' + (a.gc ? R(a.gc) : "0") + '"') +
      (a.title
        ? a.ic
          ? ' data-tooltip="' + R(a.title) + '"'
          : ' title="' + R(a.title) + '"'
        : "") +
      (a.value ? ' value="' + R(a.value) + '"' : "");
    a.attributes
      ? ((a = a.attributes),
        null != a && a.aa === qe
          ? (D(a.constructor === ve), (a = a.ha().replace(/([^"'\s])$/, "$1 ")))
          : ((a = String(a)),
            mg.test(a) ||
              (Ba("Bad value `%s` for |filterHtmlAttributes", [a]),
              (a = "zSoyz"))),
        (a = " " + a))
      : (a = "");
  ...
  var Wg = (function() {
    ...
    return rb
      ? ((a = /10[_.][0-9_.]+/),
        (a = a.exec(Va)) ? a[0].replace(/_/g, ".") : "10")
      : tb
      ? ((a = /Android\s+([^\);]+)(\)|;)/), (a = a.exec(Va)) ? a[1] : "")
      : ub || vb || wb
      ? ((a = /(?:iPhone|CPU)\s+OS\s+(\S+)/),
        (a = a.exec(Va)) ? a[1].replace(/_/g, ".") : "")
      : "";
  })();
  var Xg = function(a) {
    ...
    Yg = (function() {
      ...
      if (Jb || Kb) {
        ...
        return (a = Xg(/Android\s+([0-9.]+)/)) ? a : Xg(/Version\/([0-9.]+)/);
      return "";
    })(),
    Zg = function(a) {
      return 0 <= wa(Yg, a);
  ...
  h.wb = function(a, b, c) {
    ...
    if (this.b) {
      ...
      if ((l = Me(f)))
        (f = Se(f)),
          (f = new Ae(f.top, f.left + f.width, f.top + f.height, f.left)),
          ch(a)
            ? f.top < l.top && !(k & 1)
              ? (g -= l.top - f.top)
              : f.bottom > l.bottom && k & 1 && (g -= f.bottom - l.bottom)
            : f.left < l.left && !(k & 4)
            ? (g -= l.left - f.left)
            : f.right > l.right && k & 4 && (g -= f.right - l.right);
      ...
      if (m) {
        ...
        if (!v || "static" != Ge(m, "position")) {
          ...
          if (!v) {
            ...
            v = K
              ? -m.scrollLeft
              : !v || (pb && I("8")) || "visible" == Ge(m, "overflowX")
              ? m.scrollLeft
      ...
      m = Se(l);
      if ((v = Me(l))) {
        var Q = new Be(v.left, v.top, v.right - v.left, v.bottom - v.top);
        v = Math.max(m.left, Q.left);
        K = Math.min(m.left + m.width, Q.left + Q.width);
        v <= K &&
          ((Y = Math.max(m.top, Q.top)),
          (Q = Math.min(m.top + m.height, Q.top + Q.height)),
          Y <= Q &&
            ((m.left = v), (m.top = Y), (m.width = K - v), (m.height = Q - Y)));
      }
      v = Hd(l);
      Y = Hd(g);
      if (v.a != Y.a) {
      ...
      if (c || 0 != k)
        k & 4
          ? (l.x -= f.width + (c ? c.right : 0))
          : k & 2
          ? (l.x -= f.width / 2)
          : c && (l.x += c.left),
          k & 1 ? (l.y -= f.height + (c ? c.bottom : 0)) : c && (l.y += c.top);
      c = new Be(0, 0, 0, 0);
      c.left = l.x;
      c.top = l.y;
      c.width = f.width;
      ...
      e == f ||
        ...
        !F || I("10") || (k && I("8"))
          ? ((g = g.style),
            ...
            (g.width = Math.max(c.width, 0) + "px"),
            (g.height = Math.max(c.height, 0) + "px"))
          : ((e = g.style),
            k
              ? (F
                  ? ((k = Xe(g, "paddingLeft")),
                    (l = Xe(g, "paddingRight")),
                    (f = Xe(g, "paddingTop")),
                    (J = Xe(g, "paddingBottom")),
                    (k = new Ae(f, l, J, k)))
                  : ((k = Fe(g, "paddingLeft")),
                    (l = Fe(g, "paddingRight")),
                    (f = Fe(g, "paddingTop")),
                    (J = Fe(g, "paddingBottom")),
                    (k = new Ae(
                      parseFloat(f),
                      parseFloat(l),
                      parseFloat(J),
                ...
                F && !Fb(9)
                  ? ((l = Ze(g, "borderLeft")),
                    ...
                    (g = Ze(g, "borderBottom")),
                    (g = new Ae(J, f, g, l)))
                  : ((l = Fe(g, "borderLeftWidth")),
                    (f = Fe(g, "borderRightWidth")),
                    (J = Fe(g, "borderTopWidth")),
                    (g = Fe(g, "borderBottomWidth")),
                    (g = new Ae(
                      parseFloat(J),
                      parseFloat(f),
                      parseFloat(g),
                ...
                (e.pixelWidth = c.width - g.left - k.left - k.right - g.right),
                (e.pixelHeight =
                  c.height - g.top - k.top - k.bottom - g.bottom))
              : ((e.pixelWidth = c.width), (e.pixelHeight = c.height))));
      this.j &&
        ((g = parseFloat(this.a.style.left)),
        (c = parseFloat(this.a.style.top)),
        D(!isNaN(g) && !isNaN(c), "Could not parse position."),
        (isFinite(g) && 0 == g % 1 && isFinite(c) && 0 == c % 1) ||
          Ie(this.a, Math.round(g), Math.round(c)));
    }
    eh(this, a, b, d);
  };
  var eh = function(a, b, c, d) {
      ...
      a.b
        ? ((c = Oe(a.b, a.a)),
          (d = fh(a.b, b)),
          ch(b)
            ? (e.style.top = gh(c.y + d.y, a.a.offsetHeight - 15) + "px")
            : (e.style.left = gh(c.x + d.x, a.a.offsetWidth - 15) + "px"))
        : (e.style[
            0 == c ? (ch(b) ? "top" : "left") : ch(b) ? "bottom" : "right"
          ] = d + "px");
    },
    gh = function(a, b) {
  ...
  var jh = function(a, b) {
      a.l() &&
        ((a = a.l()),
        b
          ? Mc(a, "jfk-button-clear-outline")
          : Oc(a, "jfk-button-clear-outline"));
    },
    ih = function(a) {
      a.l() && kh(a.c, a);
    },
  ...
  lh.prototype.Pb = function() {
    chrome.runtime.sendMessage({
      audioSrc: mh(this.za, this.ya) //todo
    });
  };
  var ph = function(a, b, c) {
      var d = c.toLowerCase();
      d in nh && oh[nh[d.toLowerCase()]] >= b.length
        ? (a.U &&
            Sa(a.U, "no-audio") &&
            (0 == a.U.length && (a.U = null), Hf(a, "no-audio", !1)),
          (a.za = b),
          (a.ya = c))
        : Sf(a, "no-audio");
    },
  ...
  var Bh = function(a) {
    ...
    wh = function(a) {
      ...
      d &&
        ((k = z(a.v, a, !0)),
        (d = z(a.v, a, !1)),
        b instanceof sh ? (Ah(b, k, d), (b.G = !0)) : b.then(k, d));
  ...
  var Ih = function(a, b) {
      ...
      e.onload = e.onreadystatechange = function() {
        (e.readyState &&
          ...
          (Fh(e, c.Tb || !1, k), yh(g), zh(null), vh(g, !0, null));
      };
      e.onerror = function() {
        Fh(e, !0, k);
        th(g, new Gh(0, "Error while loading script " + d));
      };
      f = c.attributes || {};
      db(f, {
  ...
  Jh.prototype.send = function(a, b, c, d) {
    ...
    var f = /\?/.test(e) ? "&" : "?";
    for (l in a)
      for (var g = w(a[l]) ? a[l] : [a[l]], k = 0; k < g.length; k++)
        null != g[k] &&
          ((e +=
  ...
  Ph.prototype.v = function(a) {
    ...
    if (this.u) {
      ...
      (864e5 < Math.abs(b - c) || d != a) &&
        new Jh("https://translate.googleapis.com/translate_a/l", "cb").send(
          {
            client: "gtx",
            hl: d
          },
    ...
    if (a.query)
      if (a.Ob) {
        ...
        b +=
          ...
          "s" +
          "</div>";
        // alert(await getMeaning(a.query));
        // const res = await makeRequest("GET", 'http://localhost:3000/' + 'هلا')
        insert("das");
        if (a.ub) {
      ...
      Ci(this),
        0 < this.o &&
          ...
          mi(
            ...
            Ai(
              this,
              "Will abort after " + this.o + "ms if incomplete, xhr2 " + this.D
            )
          ),
          this.D
            ? ((this.a.timeout = this.o), (this.a.ontimeout = z(this.qa, this)))
            : (this.v = Vg(this.qa, this.o, this))),
        mi(this.P, Ai(this, "Sending request")),
        (this.u = !0),
        this.a.send(a),
        (this.u = !1);
    } catch (f) {
  ...
  var Gi = function(a) {
      if (a.b && "undefined" != typeof aa)
        if (a.R[1] && 4 == Hi(a) && 2 == Ii(a))
          mi(a.P, Ai(a, "Local request error detected and ignored"));
    ...
    Ji = function(a) {
      ...
      if (!c) {
        if ((b = 0 === b))
          (a = String(a.i).match(je)[1] || null),
            !a &&
              n.self &&
              n.self.location &&
              ((a = n.self.location.protocol), (a = a.substr(0, a.length - 1))),
            (b = !wi.test(a ? a.toLowerCase() : ""));
        c = b;
      }
      return c;
    },
  ...
  var Kj = function(a, b, c, d) {
    if ("" != a) {
      ...
      l.remove("dt");
      0 < e.length &&
        ((l.c = null), l.a.set(ne(l, "dt"), Ua(e)), (l.b = Ca(l.b) + e.length));
      l.set("dj", "1");
      c && l.h(c);
      m.set("q", g);
      Gj(a, k, l, m, z(a.h, a, b, void 0));
    }
  };
  Jj.prototype.a = function(a, b, c, d) {
    if (null != d) {
      for (
        var e = d.src, f = Rh(Vh), g = [], k = [], l = d.sentences, m = 0;
        m < l.length;
        m++
      )
        g.push(l[m].orig), k.push(l[m].trans);
      g = g.join("");
      k = k.join("");
      ...
      a
        ? ((a = Id(document, "more")),
          ...
          (c = new S("", void 0, 4)),
          zf(c, Id(document, "new-translation")),
          Te(Id(document, "new-translation"), !0),
          (c = Id(document, "translate-page")),
          Vd(a, rh("MSG_OPEN_IN_TRANSLATE")),
          (c.className = "gtx-a"),
        ...
        : ((a = Sd(document, "a")),
          ...
          Vd(a, rh("MSG_FOOTER_OPTIONS").toUpperCase()),
  ...
  Lj.prototype.listen = function(a, b, c, d, e) {
    var f = function(a) {
      var c = yc(b),
        e = a.target;
      e =
        y(e) && 1 == e.nodeType ? a.target.getAttribute("role") || null : null;
      "click" == a.type && kc(a)
        ? c.call(d, a)
        : (13 != a.keyCode && 3 != a.keyCode) || "keyup" == a.type
        ? 32 != a.keyCode ||
          "keyup" != a.type ||
          ("button" != e && "tab" != e) ||
          (c.call(d, a), a.preventDefault())
        : ((a.type = "keypress"), c.call(d, a));
    };
    f.ac = b;
    f.cc = d;
  ...
  var Pj = function(a, b) {
      ...
      b = Ma(b, function(a) {
        ...
        D(
          a.Lb && r(a.duration) && a.timing && r(a.tb),
    ...
    Qj = (function(a) {
      ...
      var a = Sd(document, "DIV"),
        b = H ? "-webkit" : G ? "-moz" : F ? "-ms" : nb ? "-o" : null,
        c = {
        ...
        for (m in b) {
          ...
          if (null != e) {
            ...
            if (g instanceof Vc) g = Wc(g);
              ...
              g instanceof id && g.constructor === id && g.b === hd
                ? (e = g.a)
                : (Ba(
      ...
      null != d ? w(d) || (d = [d]) : (d = []);
      !0 === Tc.div
        ? (D(!d.length, "Void tag <div> does not allow content."), (m += ">"))
        : ((c = yd(d)), (m += ">" + sd(c) + "</div>"), (c = c.ua()));
      ...
      return (
        "" !=
        ("undefined" !== typeof b ? b : a.style[Ce(a, "transition")] || "")
      );
    });
  ...
  h.play = function() {
    ...
    this.b = 1;
    if (Qj())
      return De(this.a, this.j), (this.h = Vg(this.bc, void 0, this)), !0;
    this.mb(!1);
    return !1;
  };
  h.bc = function() {
  ...
  var Vj = function(a, b) {
    a.ga &&
      ...
      (a.ga = !1),
      ia(),
      a.c ? (wc(a.c, "end", A(a.qb, b), !1, a), a.c.play()) : a.qb(b));
  };
  h = Uj.prototype;
  h.qb = function(a) {
    "toggle_display" == this.xa
      ? this.$b()
      : "move_offscreen" == this.xa && (this.J.style.top = "-10000px");
    this.dispatchEvent({
      type: "hide",
      target: a
    });
  ...
  h.Ib = function(a) {
    ...
    if ("undefined" != typeof document.activeElement) {
      if (((a = b.activeElement), !a || Ud(this.J, a) || "BODY" == a.tagName))
        return;
  ...
  var Yj = function(a) {
    var b =
      ...
      R("jfk-bubble") +
      '" role="alertdialog"' +
      (a.uid ? ' aria-describedby="' + R(a.uid) + '"' : "") +
      '><div class="' +
      R("jfk-bubble-content-id") +
      '"' +
      (a.uid ? ' id="' + R(a.uid) + '"' : "") +
      "></div>";
    if (a.dc) {
      ...
      b =
        '<div class="' +
        R("jfk-bubble-closebtn-id") +
        " " +
        R("jfk-bubble-closebtn") +
        '" aria-label="';
    ...
    b +=
      '<div class="' +
      R("jfk-bubble-arrow-id") +
      " " +
      R("jfk-bubble-arrow") +
      '"><div class="' +
      R("jfk-bubble-arrowimplbefore") +
      '"></div><div class="' +
      R("jfk-bubble-arrowimplafter") +
      '"></div></div></div>';
    return fg(b);
  };
  ...
  h.Hb = function(a) {
    ...
    if (a) {
      if (!b.ga && b.dispatchEvent("beforeshow")) {
        ...
        "toggle_display" == b.xa
          ? ((b.J.style.visibility = "visible"), Te(b.J, !0))
          : "move_offscreen" == b.xa && b.b();
        b.ga = !0;
        b.hb = ia();
  ...
  h.Zb = function(a) {
    if ("show" == a.type || "hide" == a.type) {
      ...
      c = F ? Nd(c.a) : c.a;
      "show" == a.type
        ? b.listen(c, "scroll", this.Fb)
        : b.S(c, "scroll", this.Fb);
    }
  ...
  bk.prototype.W = function(a, b) {
    ...
    b = this.j;
    D(
      q(b) || b.nodeType || b instanceof ue || b instanceof rd,
  ...
  var gk = function(a, b, c) {
    ...
    lk = function(a, b, c) {
      if (a) {
        ...
        chrome.i18n.detectLanguage(d, function(d) {
          d.isReliable
            ? c(d.languages[0].language)
            : 0 < b
            ? lk(a.parentNode, b - 1, c)
            : c("");
        });
      } else c("");
    },
    ...
    fk = function(a, b) {
      if ("1" == Th.a || b.src != Rh(Th)) {
        ...
        a.j.createShadowRoot
          ? (a.D = a.j.createShadowRoot())
          : (a.D = a.j.attachShadow({mode: 'open'}));
  ...
  for (var qk; ok.length && (qk = ok.shift()); )
    !ok.length && p(nk)
      ? (pk[qk] = nk)
      : pk[qk] && pk[qk] !== Object.prototype[qk]
      ? (pk = pk[qk])
      : (pk = pk[qk] = {});
})();
...
//   xhr.open("GET", "http://localhost:3001/" + q);
//   xhr.onload = function() {
//     if (this.status >= 200 && this.status < 300) {
//       resolve(xhr.response);
//     } else {
...
// async function getRequest(a, callback){

//     var client = new HttpClient();
//     await client.get('http://localhost:3000/' + a, function (response) {
//         // alert(response)
//         callback(response.body.innerText);
//     });
// }

// async function getMeaning(a) {
//     let result = await makeRequest("GET", 'http://localhost:3000/' + a);
...
//     // alert(document.getElementsByClassName('bubble-content'))
//     console.log(document.getElementsByClassName('gtx-body'))
// }
