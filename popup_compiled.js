...
(function () {
    ...
    var Pe = function (a) {
        ...
        a.attributes ? (a = a.attributes, null != a && a.ga === pd ? (A(a.constructor === ud), a = a.$().replace(/([^"'\s])$/, "$1 ")) : (a = String(a), Oe.test(a) || (za("Bad value `%s` for |filterHtmlAttributes",
            [a]), a = "zSoyz")), a = " " + a) : a = "";
    ...
    var vd = function (a) {
        ...
        if (a.query)
            if (a.qb) {
                ...
                b += '</select></div><div class="gtx-source-audio"><div class="jfk-button-img"></div></div><div class="gtx-body">' + He(a.query) + '</div><br><div class="gtx-language">' + He(a.Fb) + '</div><div class="gtx-target-audio"><div class="jfk-button-img"></div></div><div class="gtx-body">' +
                    He(a.qb) + "</div>";
                if (a.ab) {
